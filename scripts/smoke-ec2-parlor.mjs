...
const CASES = [
  {
    ...
    mustExclude: [/Leonardo's humour/i, /humou?r is dry and structural/i, /My humou?r is dry/i],
    needLlm: true,
  },
  {
    name: "Mona Lisa",
...
for (const c of CASES) {
  ...
  try {
    ...
    if (c.needLlm) ok &&= /leonardo|qwen|slm-fallback|:fallback/i.test(provider);
